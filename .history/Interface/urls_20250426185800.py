...
urlpatterns = [
    ...
    path('favorito/adicionar/<int:destino_id>/', views.adicionar_favorito, name='adicionar_favorito'),
    path('favorito/remover/<int:destino_id>/', views.remover_favorito, name='remover_favorito'),
]
